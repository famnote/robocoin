...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Robocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Robocoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Robocoin: 2.5 minutes
...
{
    // Robocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
